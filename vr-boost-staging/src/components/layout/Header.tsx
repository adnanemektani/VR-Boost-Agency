  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-50 px-6 pt-4">
        <header className="bg-white/60 backdrop-blur-md rounded-2xl border border-white/50 shadow-sm px-6 h-16 flex items-center justify-between">
          {/* Logo */}
          <div className="flex flex-col items-start leading-none">
  <div className="text-xl tracking-tight text-gray-900">
    <span className="font-extrabold">roche</span><span className="font-normal">bobois</span>
  </div>
  <span className="text-[8px] tracking-[0.35em] text-gray-500 uppercase mt-0.5 pl-20">paris</span>
</div>
          ...
          <div className="flex items-center gap-3 relative">
            ...
            {/* Avatar */}
            <div className="relative">
              <button onClick={() => toggle("account")} className="flex items-center gap-2 px-2 py-1 rounded-xl hover:bg-gray-100 transition">
                ...
                <ChevronDown size={14} className="text-gray-400" strokeWidth={1.5} />
              </button>
              <AnimatePresence>
